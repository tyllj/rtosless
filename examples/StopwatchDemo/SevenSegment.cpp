...
static constexpr uint8_t font_lookup(char c) {
...
: _shift(data, shiftClock, storageClock, rl::drv::bit_order_t::LSBFIRST),
_storageClock(storageClock),
_chars{0},
_points{0},
_n(0),
...
void SG::SevenSegment::init() {
    rl::timer_create_member<SG::SevenSegment>(
        this,
        &SG::SevenSegment::refresh,
        1,    // interval in ms
        0,    // phase
        TIMER_RESOLUTION_MILLIS,    // resolution
        SCHED_PRIO_LOW,    // priority
        0     // one_shot = false
    );
}
